# Temporal GNN network intrusion detection

A temporal graph neural network approach for network intrusion detection using GNN/GRU models on NF-CSE-CIC-IDS2018-v3.

## Lateral-movement sensitivity study
